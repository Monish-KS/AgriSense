...
const csvFilePath = path.join(__dirname, '../India_data/ICRISAT-District Level Data (1).csv');
const jsonFilePath = path.join(__dirname, '../src/data/icrisat_district_data_1.json');
const results = [];

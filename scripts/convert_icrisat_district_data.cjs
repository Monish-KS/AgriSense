...
const csvFilePath = path.join(__dirname, '../India_data/ICRISAT-District Level Data.csv');
const jsonFilePath = path.join(__dirname, '../src/data/icrisat_district_data.json');
const results = [];

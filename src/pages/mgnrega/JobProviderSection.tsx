    ...
    <Layout>
      <div className="p-6 lg:p-12 flex flex-col items-center relative"> {/* Added relative positioning */}
        <Button
          ...
          className="absolute top-6 left-6 border-[#8B4513] text-[#8B4513] hover:bg-[#8B4513] hover:text-white transition-colors"
        >
          Back to Portal
        </Button>
        <h1 className="text-3xl md:text-4xl font-bold text-[#8B4513] mb-8 flex items-center gap-3">
          Job Provider Portal <BriefcaseBusiness className="h-8 w-8" />
        </h1>
        ...
        <Button
          type="submit"
          className="w-full bg-[#8B4513] hover:bg-[#CD853F] transition-colors text-white" // Added text-white
        >
